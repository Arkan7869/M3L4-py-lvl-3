...
#fungsi ini akan berjalan saat program di mulai
@bot.event
async def on_ready():
    print(f'Bot is ready. Logged in as {bot.user}')

#fungsi ini untuk memperkenalkan tentang bot yang akan digunakan
...
#funsgi ini untuk memberikan informasi atau perintah yang dapat digunakan untuk membantu anda saat menggunakan bot ini
...
#fungsi ini digunakan saat anda  membuat proyek baru
...
#fungsi ini digunakan untuk memilih proyek yang sudah dibuat
...
#fungsi ini digunakan untuk menambahkan keterampilan ke proyek yang sudah dibuat
...
async def skills(ctx):
    ...
    if projects:
        ...
        await ctx.send('Kamu belum memiliki proyek!\nKamu dapat menambahkannya menggunakan perintah !new_project')
    #fungsi ini untuk menghapus proyek
...
async def delete_project(ctx):
    ...
    if projects:
        ...
        await ctx.send('Kamu belum memiliki proyek!\nKamu dapat menambahkannya menggunakan perintah !new_project')
    #fungsi ini untuk memperbarui atau mengubah proyek
